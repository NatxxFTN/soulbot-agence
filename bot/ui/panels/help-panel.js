...
/**
 * Construit le panel ;help Components V2.
 * @param {string|null} category - Catégorie active (null = première dispo)
 * @param {number} page - Page active (1-indexée)
 */
...
module.exports = { renderHelpPanel };
